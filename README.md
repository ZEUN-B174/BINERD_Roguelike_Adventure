...
<br>**1월 16일:** 먼저 전투를 시스템화해서 정예, 보스 구역에서도 같은 시스템을 사용할 수 있게 만들었습니다. (사건에서 전투로 넘어가는 경우에도 사용 할 수 있습니다.) 또한 어제 만들다 만 버프 시스템을 구현했고, 드디어 전투 시스템에서 연속 공격이 제대로 나오게 만들었습니다. 그리고 플레이어 캐릭터 상호작용도 보이게 구현했습니다. 나중에 적 이미지도 추가해 구현할 예정입니다.
