...
define config.name = _("비네르드: 로그라이크 어드벤처")
...
define config.version = "0.2.1 Alpha"
...
define gui.about = _p("""
여러분은 쿠르디스탄의 천재 프로그래머 다스니 박사의 조수가 되어 그녀의 실험을 도와주게 됩니다.
3개의 층으로 이루어진 시뮬레이션 던전에 입장해 각 층마다 있는 보스와 싸워 승리를 거머쥐어 봅시다!
잠깐 …뭐? 버그가 있다고…? 그치만 이건 아직 베타 버전인걸!
""")
...
define build.name = "BINERD_Roguelike_Adventure"
...
define config.save_directory = "BINERD_Dungeon_Adventure-1744433827"
